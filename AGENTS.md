...
- For commits containing Codex-assisted work, use the `Co-authored-by: Codex <codex@openai.com>` commit-message trailer. Keep commit subjects free of `@codex` mentions; attribution belongs in the co-author metadata.
